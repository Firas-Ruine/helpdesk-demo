...
import { MoreHorizontal, Search, Trash2, RefreshCw } from "lucide-react"
import Link from "next/link"
import { getTicketsByStatus } from "@/lib/mock/ticket-data"

// Sample data for deleted tickets
const ticketsData = getTicketsByStatus("Deleted")
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <CardTitle>Tickets in Trash</CardTitle>
          ...
          <CardDescription>View and manage tickets that have been moved to trash.</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
